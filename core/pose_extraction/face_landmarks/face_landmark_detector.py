# /Users/kevin/Desktop/Piensa/driver-monitoring-app-copy/core/pose_extraction/face_landmarks/face_landmark_detector.py
...
class FaceMeshExtractor:
    ...
    def get_chin_points(self, face_points: List[List[int]]) -> Dict[str, List[List[int]]]:
        feature_indices = {
            'chin': {
