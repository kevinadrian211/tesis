...
lock = threading.Lock()  # Para sincronizar acceso a variables globales
...
def start_blink_reporting():
    t = threading.Thread(target=generate_report, daemon=True)
    t.start()

# Iniciar automáticamente el reporte
