...
class ViewDetailedReportsAdminScreen(Screen):
    ...
    def load_screen_data(self):
        ...
        try:
            ...
            print(f"Cargando reportes detallados - Tipo admin: {self.current_report_type}, Trip ID: {self.current_trip_id}")
    ...
    def update_screen_info(self):
        ...
        try:
            ...
            if self.current_trip_id:
                self.ids.trip_info_label.text = f"Viaje ID admin: {self.current_trip_id[:8]}..."
